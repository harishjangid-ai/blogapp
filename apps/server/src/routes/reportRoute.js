...
import { getMyReports, getReports, reportBlog, updateReportStatus } from "../controllers/reportController.js";
...
reportRouter.get("/get-my-reports", verifyToken, getMyReports);
